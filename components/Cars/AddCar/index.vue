    ...
    <form class="form">
      ...
      <div class="form-group info">
        <div class="info-item">
          ...
          <span
            class="info-message form-message-error"
            v-if="errors.yearOfProd !== ''"
            >{{ errors.yearOfProd }}</span
          >
        </div>
        <div class="info-item">
          <app-select-with-search-input
      ...
      <div class="form-group info">
        ...
        <div v-if="carEquipment.length" class="info-item full-width">
          <app-tag-lish-item
            v-for="(item, index) in carEquipment"
            :key="index"
            :item="item"
            @removeTagLishItem="onTagLishItemRemoveClick"
          ></app-tag-lish-item>
        </div>
      </div>
      ...
      <div class="form-group info">
        ...
        >
          ...
          />
          <label class="drop-input--label" for="drop-input"
            >Dodaj zdjęcia</label
          >
        </div>
        <div class="images-thumbs">
          <app-image-thumb
            ...
            :image="image"
            @click.native="
              editedCar ? addToRemove($event, image) : removeImage(image)
            "
          ></app-image-thumb>
        </div>
      </div>
      <div class="form-group info">
        ...
        <div class="info-item info-item--contact">
          ...
          <span class="info-message form-message-error" v-if="errors.email">{{
            errors.email
          }}</span>
        </div>
        <div class="info-item info-item--contact">
      ...
      <button class="form-button-submit" @click.prevent="addCar">
        {{ editedCar ? "Zapisz ogłoszenie" : "Dodaj ogłoszenie" }}
      </button>
    </form>
  </section>
</template>
  ...
  computed: {
    ...
    models() {
      ...
      if (this.brands.filter((brand) => brand.brand === this.brand)[0]) {
        brandModels = this.brands.filter(
  ...
  methods: {
    ...
    addCar() {
      ...
      let newCar = {
        ...
        countryOfProd:
          this.countryOfProd === "Kraj pochodzenia" ? "" : this.countryOfProd,
      ...
      // console.log(newCar);
      let url = this.editedCar
        ? "/api/cars/edit/" + this.editedCar._id
        ...
        .then((response) => {
          if (response.data.errors) {
            ...
            this.errors.category = response.data.errors.category
              ? response.data.errors.category.message
              : "";
            this.errors.version = response.data.errors.version
              ? response.data.errors.version.message
              : "";
            this.errors.fuel = response.data.errors.fuel
              ? response.data.errors.fuel.message
              : "";
            this.errors.price = response.data.errors.price
              ? response.data.errors.price.message
              : "";
            this.errors.mileage = response.data.errors.mileage
              ? response.data.errors.mileage.message
              : "";
            this.errors.yearOfProd = response.data.errors.yearOfProd
              ? response.data.errors.yearOfProd.message
              : "";
            this.errors.location = response.data.errors.location
              ? response.data.errors.location.message
              : "";
    ...
    checkFilesAndResize(files) {
      ...
      filesArray.forEach((file) => {
        let imageToUpload = { src: "", title: "", isLoading: true };
        this.images.push(imageToUpload);
        this.uploadImage(file, imageToUpload);
      });
    },
    uploadImage(file, imageToUpload) {
      const formData = new FormData();
      formData.append("max_image_dimension", this.MAX_IMAGE_DIMENSION);
      formData.append("directory", this.user);
    ...
    parseForEdit() {
      ...
      this.firstRegistration =
        this.editedCar.firstRegistration || this.firstRegistration;
      ...
      this.additionalInfo.registerInPoland.value =
        this.editedCar.registerInPoland;
      ...
      this.additionalInfo.registerAsAntique.value =
        this.editedCar.registerAsAntique;
